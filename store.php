...
<head>
    ...
    <title>store-clemence-medical-store</title>
        ...
        <div class="row">
            <div class="box">
               ...
               <div class="col-lg-12 text-center">
                    <img class="img-responsive img-border img-full" src="img/22.jp2g" alt=""><br><br>
                    <form id="add" name="add" method="post" action="save.php">
<table border="0" align="center">
  ...
  <strong>
    ...
    <td><input name="uprice" type="text" id="uprice" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
