...
if(isset($_POST['btn-login']))
{
    ...
    $res=mysql_query("SELECT * FROM login_tbl WHERE email='$email'");
                ...
                <div class="col-md-6">
                   <form method="post" action="">
                    <table>
                        ...
                        <tr><td><input type="submit" name="btn-login" id="btn-login" value="Login"></td></tr>
                        <tr><td><a href="register.php"><b>Create an account</b></a></td></tr>
                    </table>
                   </form>
